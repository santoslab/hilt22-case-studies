...
//     sireum proyek run . tc.Demo
//
//   To see the available CLI options:
//     sireum proyek run . tc.Demo -h
//
//   To run the example unit tests from the command line:
//     sireum proyek test .
//
//   To build an executable jar:
//     sireum proyek assemble --uber --main tc.Demo .
//
// Sireum IVE:
//
...
//     Right click src/main/architecture/tc/Demo.scala and choose "Run 'Demo'"
//
...
val slangModule: Module = Module(
  id = "TempControlSoftwareSystem_p_Instance",
